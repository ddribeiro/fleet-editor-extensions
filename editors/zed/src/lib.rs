//! Zed extension for Flint YAML validation.
//!
//! This extension integrates the flint LSP server with Zed,
...
/// The Flint extension for Zed.
struct FlintExtension {
    /// Cached path to the flint binary.
    cached_binary_path: Option<String>,
}

/// Binary name.
const BINARY_NAME: &str = "flint";

/// GitHub repository for releases.
const GITHUB_REPO: &str = "headmin/fleet-editor-extensions";
...
impl FlintExtension {
    ...
    fn get_binary_path(&mut self, language_server_id: &LanguageServerId, worktree: &zed::Worktree) -> Result<String> {
...
impl zed::Extension for FlintExtension {
    ...
    fn language_server_command(
        ...
        let binary_path = self.get_binary_path(language_server_id, worktree)?;
